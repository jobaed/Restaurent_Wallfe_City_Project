...
<?php } ?>
                        <h1 class="">Trending products</h1>
                        <a href="#" class="btn py-2 px-4 mt-2" style="background-color: #fcb119;"><span
                                class="bg-light text-dark py-1 px-2 borderd">See the menu card</span></a>
                    </div>
    ...
    <section data-aos="fade-up" class="container-fluid">
        <div class=" wrapper-container col-md-6">
            ...
            <div class="text-center testemonial-wrapper">
                ...
                <a href="selection.php"><button class="btn btn-warning">See The Selection</button></a>
            </div>
            <?php } ?>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <a href="<?php echo $all['url'] ?>">
                        <img src="assets/img/<?php echo $all['image'] ?>" class="img-fluid" alt="">
                    </a>
                </div>
